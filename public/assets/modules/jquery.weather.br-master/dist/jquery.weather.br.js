...
;(function ( $, window, document, undefined ) {
    ...
    var getXML = function(url, callbackSuccess, callbackError)
      ...
      var url = 'https://weather-ydn-yql.media.yahoo.com/forecastrss';
			...
			var concat = '&';
			var query = {'lat': settings.locationLat,'lon':settings.locationLon, 'format': 'json','u':'c'};
			var oauth = {
            ...
            if (settings.format.toLowerCase() === 'week') {
                ...
                $.each(forecasts, function(index) {
                    if(index < 7){
                        ...
                        forecast.find('.temperature .low').html(getTemperature(this.low) + '&deg;');
                        forecast.find('.temperature .high').html(getTemperature(this.high) + '&deg;');
