        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <form method="POST" name="addmanejo" action="{{route('painel.storePerdaEstoque', ['estoque'=>$estoque])}}"  class="needs-validation p-0 col-sm-8 col-md-8 col-lg-8 align-self-center" novalidate="">
                        {{ csrf_field() }}
                        <div class="card-body">
