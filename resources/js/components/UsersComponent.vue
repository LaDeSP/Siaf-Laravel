        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a v-bind:href="$parent.MakeUrl('painel/users/create')" class="btn btn-primary">Add <i class="fas fa-plus"></i></a>
                </div>
            </div>
                    ...
                    <table class="table table-striped" v-if="users.length">
                        <tbody>
                            ...
                            <tr v-for="user, index in users">
                                ...
                                <td class="text-right">
                                    <button v-if="!user.isme" @click="deleteUser(user.id, index)" class="btn btn-danger">
                                        <i class="fa fa-trash"></i>
                                    </button>
                                    <a v-bind:href="user.profilelink" class="btn btn-primary">
...
export default {
    ...
    mounted() {
        ...
        this.url = BaseUrl('painel/users?q='+this.query);
        this.loadUsers();
    },
    methods: {
        loadUsers() {
        ...
        deleteUser(userId, index) {
            ...
            this.$iosConfirm({
                ...
                axios.delete(_this.$parent.MakeUrl('painel/users/'+userId)).then((res) => {
